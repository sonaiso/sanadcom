...
export const URL_MODEL_MAP: ModelMap = {
	...
	'workflow-cases': {
		name: 'workflowcase',
		localName: 'workflowCase',
		localNamePlural: 'workflowCases',
		verboseName: 'Workflow case',
		verboseNamePlural: 'Workflow cases',
		foreignKeyFields: [
			{ field: 'folder', urlModel: 'folders', urlParams: 'content_type=DO&content_type=GL' },
			{ field: 'owners', urlModel: 'actors' },
			{ field: 'reviewers', urlModel: 'actors' },
			{ field: 'affected_assets', urlModel: 'assets' },
			{ field: 'requirement_assessments', urlModel: 'requirement-assessments' },
			...
			{ field: 'security_exceptions', urlModel: 'security-exceptions' },
			{ field: 'filtering_labels', urlModel: 'filtering-labels' },
			{ field: 'residual_risk_reassessed_by', urlModel: 'users' }
		],
		selectFields: [
			{ field: 'workflow_type' },
		...
		detailViewFields: [
			...
			{ field: 'remediation_completion' },
			{ field: 'closure_notes' },
			{ field: 'residual_risk_summary' },
			{ field: 'residual_risk_reassessed_at', type: 'datetime' },
			{ field: 'residual_risk_reassessed_by' },
			{ field: 'created_at', type: 'datetime' },
			{ field: 'updated_at', type: 'datetime' },
